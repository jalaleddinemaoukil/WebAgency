  ...
  return (
    <html lang="en">
      <body className={font.className} >
        ...
        <div className=" p-10 text-center bg sm:p-8 bg-dark-blue ">
                <h1 className="mb-2 text-6xl font-bold text-gray-900 dark:text-white mt-7 font-sans">V Y N E</h1>
                <ul className="flex flex-wrap items-center justify-center mb-6 text-gray-900 dark:text-white gap-9 mt-10">
                    ...
                    <li>
                        <button ><a href="#" className="mr-4 hover:underline md:mr-6 ">Sign up</a></button>
                    </li>
                    <li>
